...
export default {
    ...
    return {
      ...
      events: {
        ...
        entries: [
          ...
          { id: 2, title: 'Another Event', date: new Date().toLocaleDateString(), location: 'Chicago', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 3, title: 'Long Event', date: new Date().toLocaleDateString(), location: 'Dubai', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 4, title: 'Short Event', date: new Date().toLocaleDateString(), location: 'Rome', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 5, title: 'Avb Event', date: new Date().toLocaleDateString(), location: 'New York', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 6, title: 'Lorem Event', date: new Date().toLocaleDateString(), location: 'Dallas', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 7, title: 'Ipsum Event', date: new Date().toLocaleDateString(), location: 'Los Angeles', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' },
          { id: 8, title: 'Evelum Event', date: new Date().toLocaleDateString(), location: 'Seattle', summary: 'Morbi cursus efficitur augue et molestie. Nulla nec maximus ipsum. In vestibulum tincidunt ipsum, a placerat nunc. Proin viverra diam mauris, a malesuada urna aliquam vel. Praesent a sem velit. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin nibh augue, aliquet ac enim et, elementum rutrum nisi. Sed vel quam ac quam pellentesque molestie et vel augue.' }
        ]
      }
    }
  },
  methods: {
    randomPicture (x = 100, y = 60) {
      globalCounter++
      return `https://placeimg.com/${x}/${y}/any?date=${new Date().getTime()}&i${globalCounter}=${globalCounter}`
    }
  }
}
</script>
